                ...
                <table class="table table-bordered table-hover table-full-width " id="table" style="width: 100%;">
                    <thead>
                         <tr>
                          ...
                          <th scope="col" width="10%">Tanggal Pengajuan</th>
                          <th scope="col" width="10%">Nama Pelatihan</th>
                          <th scope="col" width="10%">NIK</th>
                          <th scope="col" width="10%">Nama Peserta</th>
                          <th scope="col" width="10%" class="text-center">Atasan Langsung</th>
