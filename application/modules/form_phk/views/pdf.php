...
<div class="style4">
  ...
  Perihal : Pengajuan PHK Karyawan  <br/><br/>
  Kepada Yth.,<br/>
  Departemen HRD<br/>
  Di Tempat<br/>

  <p>Dengan hormat,</p>
  <p>Sesuai evaluasi kinerja karyawan terlampir, bersama ini kami sampaikan permohonan proses PHK karyawan atas nama   dengan data sebagai berikut:</p>
</div>
...
<table width="800" align="center">
  <tbody>
    ...
    <tr>
      <td align="center"> <br/>Pengaju</td>
    <?php if(!empty($row->user_app_lv1)){?>
      <td align="center"> <br/>Atasan Langsung</td>
    <?php }?>
    <?php if(!empty($row->user_app_lv2)){?>
      <td align="center"> <br/>Atasan tidak langsung</td>
      <?php }?>
...
<table width="800" align="center">
  <tbody>
    ...
    <tr>
      <?php if(!empty($row->user_app_lv3)){?>
        <td align="center"> <br/>Atasan lainnya</td>
      <?php }?>
      <?php if(!empty($row->user_app_lv4)){?>
        <td align="center"> <br/>Atasan lainnya</td>
      <?php }?>
