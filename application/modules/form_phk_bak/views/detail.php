                  ...
                  <div class="row column-seperation">
                    ...
                    <div class="col-md-7">
                      ...
                      <div class="row form-row">
                        ...
                        <div class="col-md-8">
                          <textarea name="alasan" id="alasan" type="text"  class="form-control" placeholder="Alasan phk" readonly="readonly" style="min-height: 200px;"><?php echo $row->alasan?></textarea>
                        </div>
                      </div>
                      <div class="row form-row">
                        <div class="col-md-12">
                      ...
                      <div id="note">
                        ...
                        <div class="row form-row">
                          ...
                          <div class="col-md-8">
                            <textarea name="notes_spv" class="form-control" readonly="readonly" style="min-height: 200px;"><?php echo $row->$note_lv ?></textarea>
                          </div>
                        </div>
                        <?php } ?>
                      <?php endfor;?>
                      ...
                      <?php if(!empty($row->note_hrd)){?>
                        <div class="row form-row">
                          ...
                          <div class="col-md-8">
                            <textarea name="notes_spv" class="form-control" readonly="readonly" style="min-height: 200px;"><?php echo $row->note_hrd ?></textarea>
                          </div>
                        </div>
                      <?php } ?>
                    </div>
