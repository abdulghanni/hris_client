				            					        		...
				            					        		<div class="row">
				            					              	...
				            					              	<div class="row wf-cuti">
				            					                	<div class="col-md-3" id="lv1">
				            					                          ...
				            					                          <span class="semi-bold"><?php echo get_name($kpi_detail['created_by'])?></span><br/>
				            					                          <span class="small"><?php echo dateIndo($kpi_detail['created_on'])?></span><br/>
				            					                          <span class="semi-bold"><?=get_user_position($kpi_detail['created_by'])?></span>
				            					                  		</p>
				            					                	</div>
				            					                	<?php 
