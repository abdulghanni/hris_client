...
class Form_training_model extends CI_Model
{
    ...
    public function form_training($id = null)
    {
        ...
        else
        {
            ...
            $this->db->join('training_ikatan_dinas', 'users_training.ikatan_dinas_id = training_ikatan_dinas.id', 'LEFT');
            $this->db->join('training_waktu', 'users_training.waktu_id = training_waktu.id', 'LEFT');
            $this->db->join('approval_status as status_lv1', 'users_training.approval_status_id_lv1 = status_lv1.id', 'left');
            $this->db->join('approval_status as status_lv2', 'users_training.approval_status_id_lv2 = status_lv2.id', 'left');
            $this->db->join('approval_status as status_lv3', 'users_training.approval_status_id_lv3 = status_lv3.id', 'left');
            $this->db->join('approval_status as status_hrd', 'users_training.approval_status_id_hrd = status_hrd.id', 'left');
            ...
            if($is_approver == $sess_nik || $is_admin_cabang == 1){
                $this->db->where_in("users_training.user_pengaju_id", $user);
            ...
            $this->db->order_by('users_training.id', 'desc');
        }
