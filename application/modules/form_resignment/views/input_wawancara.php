        ...
        <div class="col-md-12">
          <div class="grid simple">
            ...
            <div class="grid-body no-border">
              <form action="<?php echo site_url('form_resignment/add')?>" method="POST" class="form-no-horizontal-spacing">
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <div class="checkbox check-primary checkbox-circle" >
                            ...
                            <input name="alasan_resign_id[]" id="alasan-<?php echo $row->id?>" class="checkbox1" type="checkbox" value="<?php echo $row->id?>">
