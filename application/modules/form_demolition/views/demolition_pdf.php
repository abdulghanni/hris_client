...
<?php foreach($form_demolition->result() as $row):?>
<table width="1000" height="135" border="0" align="center" style="padding-left:30px">
  ...
  <tr>
    ...
    <td height="45"><div align="center">:</div></td>
    <td height="45"><span class="style3"><?php echo (!empty($user_info))?$user_info['BU']:'-';?></span></td>
  </tr>
  <tr>
    <td height="45"><span class="style3">Dept/Bagian </span></td>
    <td height="45"><div align="center">:</div></td>
    <td height="45"><span class="style3"><?php echo (!empty($user_info))?$user_info['ORGANIZATION']:'-';?></span></td>
  </tr>
  <tr>
    <td height="45"><span class="style3">Jabatan</span></td>
    <td height="45"><div align="center">:</div></td>
    <td height="45"><span class="style3"><?php echo (!empty($user_info))?$user_info['POSITION']:'-';?></span></td>
  </tr>
  <tr>
...
<table width="1000" height="135" border="0" style="padding-left:30px;">
  <tr>
    <td width="275" height="45"><span class="style3">Alasan Demolition</span></td>
    <td width="10" height="45"><div align="center">:</div></td>
    <td width="445" height="45"><span class="style3"><?php echo $row->alasan_demolition?></span></td>
  </tr>
  <tr>
    <td height="45"><span class="style3">Memenuhi Syarat</span></td>
    <td height="45"><div align="center">:</div></td>
    <td height="45"><span class="style3"><?php echo ($row->memenuhi_syarat == 1)? 'Ya' : 'Tidak'?> </span></td>
  </tr>
</table>
...
<table width="1000" align="center">
  <tbody>
    ...
    <tr>
      ...
      <td align="center"></td>
      <td align="center"></td>
      <td align="center" class="style3"><?php echo get_name($row->user_app)?><br/><?php echo dateIndo($row->date_app)?></td>
    </tr>
  </tbody>
</table>
