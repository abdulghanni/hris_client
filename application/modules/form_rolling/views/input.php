          ...
          <div class="col-md-12">
            <div class="grid simple">
              ...
              <div class="grid-body no-border">
                <?php
                $att = array('class' => 'form-no-horizontal-spacing', /*'id' => 'formaddrolling'*/);
                echo form_open('form_rolling/add', $att);
                ?>
                  <div class="row column-seperation">
                    <div class="col-md-5">
                      ...
                      <div class="row form-row">
                        ...
                        <div class="col-md-9">
                          <?php if(is_admin()){?>
                            <select id="emprolling" class="select2" style="width:100%" name="emp">
                              <?php
