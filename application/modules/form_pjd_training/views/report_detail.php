        ...
        <div class="col-md-12">
          <div class="grid simple">
            ...
            <div class="grid-body no-border">
             <?php echo form_open_multipart('form_pjd_training/add_report/'.$this->uri->segment(3));?>
                ...
                <div class="form-actions text-center">
                  ...
                  <?php if ($this->session->userdata('user_id') == $td->task_receiver && $n_report== 0|| get_nik($this->session->userdata('user_id')) == $td->task_receiver && $n_report== 0) { ?>
                    ...
                    <a href="<?php echo site_url('form_pjd_training')?>"><button class="btn btn-white btn-cons" type="button">Cancel</button></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php 
            ...
            echo form_open_multipart('form_pjd_training/update_report/'.$id_report.'/'.get_id($report_creator), $att)?>
            <h4>Laporan Kegiatan PJD</h4>
            <div class="row form-row">
              <div class="col-md-4">
                <label class="form-label text-left">Sudah Terlaksana : </label>
