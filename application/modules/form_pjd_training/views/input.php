        ...
        <div class="col-md-12">
          <div class="grid simple">
            <div class="grid-title no-border">
              <h4><a href="<?php echo site_url('form_pjd_training')?>">Form Perjalanan Dinas Training/Meeting</a></h4>
            </div>
            <div class="grid-body no-border">
              ...
              <?php 
                ...
                echo form_open('form_pjd_training/add', $att); ?>
                ...
                <div class="form-actions">
                  <div class="pull-right">
                    ...
                    <a href="<?php echo site_url() ?>form_pjd_training"><button id="btnCancel" class="btn btn-white btn-cons" type="button" style="display: none;">Cancel</button></a>
                  </div>
                </div>
              </form>
            </div>
