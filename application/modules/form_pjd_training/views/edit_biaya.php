          ...
          <div class="col-md-12">
            <div class="grid simple">
              <div class="grid-title no-border">
                <h4>Ubah Data <span class="semi-bold"><a href="<?php echo site_url('form_pjd_training')?>">Perjalanan Dinas Training/Meeting</a></span></h4>
              </div>
              <div class="grid-body no-border">
                <?php echo form_open('form_pjd_training/do_edit/'.$id)?>
                    ...
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          <th width="15%">Nama</th>
                          <th width="1%">Gol</th>
                          <th width="10%">Uang Makan Perjalanan</th>
                      ...
                      <?php foreach ($detail->result() as $key):?>
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <?php $i = 0;
                              $c = getJoin('users_spd_training_biaya','pjd_training_biaya','users_spd_training_biaya.pjd_biaya_id = pjd_training_biaya.id','left', 'users_spd_training_biaya.*, pjd_training_biaya.title as jenis_biaya, pjd_training_biaya.type_grade as type', array('user_spd_luar_group_id'=>'where/'.$id, 'user_id'=>'where/'.$key->user_id),array('!=type_grade'=>'0'));
                          ...
                          <input type="hidden" class="form-control" name="emp[]" value="<?php echo $key->user_id?>" />
                            ...
                            <?php endforeach;
                              $j = 0;
                              $b = getJoin('users_spd_training_biaya','pjd_training_biaya','users_spd_training_biaya.pjd_biaya_id = pjd_training_biaya.id','left', 'users_spd_training_biaya.*, pjd_training_biaya.title as jenis_biaya, pjd_training_biaya.type_grade as type', array('user_spd_luar_group_id'=>'where/'.$id, 'user_id'=>'where/'.$key->user_id, 'type_grade'=>'where/0'));
