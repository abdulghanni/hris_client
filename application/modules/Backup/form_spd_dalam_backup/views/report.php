            ...
            <div class="grid-body no-border">
             <?php echo form_open_multipart('form_spd_dalam/add_report/'.$this->uri->segment(3));?>
                ...
                <div class="form-actions text-center">
                  ...
                  <?php if ($this->session->userdata('user_id') == $td->user_id && $n_report== 0|| get_nik($this->session->userdata('user_id')) == $td->user_id && $n_report== 0) { ?>
                    <button class="btn btn-danger btn-cons" type="submit"><i class="icon-ok"></i> Save</button>
                    <a href="<?php echo site_url('form_spd_dalam')?>"><button class="btn btn-white btn-cons" type="button">Cancel</button></a>
                    <?php }elseif ($this->session->userdata('user_id') != $td->user_id && $n_report== 0) { ?>
                            <p class="">...............................</p>
                          <?php }elseif($this->session->userdata('user_id') == $td->user_id && $n_report== 1|| get_nik($this->session->userdata('user_id')) == $td->user_id && $n_report== 1){ ?>
                          <p class="wf-submit">
...
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="editspddalamModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
