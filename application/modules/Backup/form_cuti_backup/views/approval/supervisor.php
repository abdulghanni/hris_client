                ...
                <form class="form-no-horizontal-spacing" id="formAppLv1" action="<?php// echo site_url('form_cuti/do_approve_spv/2')?>">
                  <div class="row column-seperation">
                    ...
                    <div class="row form-row">
                      ...
                      <div class="col-md-9">
                        <input name="seniority_date" id="seniority_date" type="text"  class="form-control" placeholder="Lama Bekerja" value="<?php echo date('d F Y',strtotime($seniority_date)); ?>" disabled="disabled">
                      </div>
                    </div>          
                    <div class="row form-row">
                      <div class="col-md-3">
                    ...
                    <div class="col-md-7">
                      ...
                      <div class="row form-row">
                        ...
                        <div class="col-md-9">
                          <textarea name="notes_spv" class="custom-txtarea-form" placeholder="Note supervisor isi disini"><?php echo $user->note_app_lv1 ?></textarea>
                        </div>
                      </div>
...
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="notapprovecutiModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
