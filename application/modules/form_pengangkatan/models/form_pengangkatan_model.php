...
class Form_pengangkatan_model extends CI_Model {
    ...
    private function _get_datatables_query($f)
    {
        ...
        $this->db->select(array(
                ...
                'users_pengangkatan'.'.app_status_id_lv1',
                'users_pengangkatan'.'.app_status_id_lv2',
                'users_pengangkatan'.'.app_status_id_lv3',
                'users_pengangkatan'.'.app_status_id_hrd',
                'users_pengangkatan'.'.user_app_lv1',
                'users_pengangkatan'.'.user_app_lv2',
                'users_pengangkatan'.'.user_app_lv3',
                'users_pengangkatan'.'.created_by',
                $this->table.'.created_on',
                'empl_status'.'.title as empl_status',
            ...
            $this->db->from('users_pengangkatan');


            $this->db->join($this->join1, 'users_pengangkatan.user_id = users.id', 'left');
            $this->db->join($this->join1.' as pengaju', 'users_pengangkatan.created_by = pengaju.id', 'left');
            $this->db->join($this->join2, 'users_pengangkatan.status_pengangkatan_id = empl_status.id', 'left');
    ...
    function detail($id){
        $this->db->select(array(
            ...
            $this->db->where('users_pengangkatan.is_deleted', 0);
            $this->db->where('users_pengangkatan.id', $id);
