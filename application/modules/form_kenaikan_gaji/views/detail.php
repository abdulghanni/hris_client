          ...
          <div class="col-md-12">
            <div class="grid simple">
              <div class="grid-title no-border">
                <h4>Form <span class="semi-bold"><a href="<?php echo site_url('form_kenaikan_gaji')?>">Kenaikan Gaji</a></span></h4>
                <a href="<?php echo site_url('form_kenaikan_gaji/form_kenaikan_gaji_pdf/'.$id)?>" target="_blank"><button class="btn btn-primary pull-right"><i class="icon-print"> Cetak</i></button></a><br/>No : <?= get_form_no($id) ?>
              </div>
              <div class="grid-body no-border">
                ...
                <div class="row form-row">
                  <div class="col-md-12">
                    <?php if($row->is_deleted == 0 && ($sess_id == $created_by)){?>
                      <!-- <a href="<?php echo site_url('form_kenaikan_gaji/edit_komponen/'.$id)?>">
                        <div class='btn btn-primary text-center' title='Edit PJD'><i class='icon-edit'> Ubah Komponen</i></div>
                      </a> -->
                    <?php }else{
                    //echo $row->is_deleted;
                    //echo $sess_id;
                      ...
                      <table class="table table-bordered">
                        ...
                        <?php foreach ($komponen->result() as $key):?>
                          <tr>
                            <td>
                ...
                <div class="form-actions">
                  <div class="row form-row">
                    ...
                    <?php }endfor;
                      if($row->is_app_hrd == 1 && get_nik($sess_id) == $this->approval->approver('demosi', $user_nik)){?>
                ...
                <div class="row wf-cuti">
                  ...
                  <div class="col-md-3" id="hrd">
                    ...
                    <div class="col-md-12"><span class="semi-bold">Diterima HRD</span><br/><br/></div>
                      <?php if($row->is_app_hrd == 0 && $this->approval->approver('demosi', $user_nik) == $sess_nik){?>
                      ...
                      <?php }else{?>
                        ...
                        <span class="small"></span><br/>
                        <span class="semi-bold"></span><br/>
                        <span class="semi-bold"><?php echo get_name($this->approval->approver('demosi', $user_nik))?></span><br/>
                        <span class="small"><?php echo dateIndo($row->date_app_hrd)?></span><br/>
                        <span class="semi-bold">(HRD)</span>
                      <?php } ?>
                    </p>
