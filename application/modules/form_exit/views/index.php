                  ...
                  <table class="table table-bordered table-hover table-full-width " id="table" style="width: 100%;">
                      <thead>
                           <tr>
                            ...
                            <th rowspan="2" scope="col" width="15%">Nama Pengaju</th>
                            <th rowspan="2" scope="col" width="15%">Nama Karyawan</th>
                            <th rowspan="2" scope="col" width="10%">Tanggal Keluar</th>
                            <th rowspan="2" scope="col" width="10%">Tanggal Pengajuan</th>
                            <th colspan="3" scope="col" width="16%" class="text-center">Approval Atasan</th>
