...
class personal_assesment extends MX_Controller {
    ...
    function print_pdf($id){
        ...
        $data['kode_surat'] = get_no_surat('PAS',$this->table,$id);
        ...
        $html = $this->load->view('competency/personal_assesment/print_pdf',$data, true); 
    ...
    function add(){
        ...
        // $pas=select_all_order_row($this->table,'id','DESC')->row();
        // $pas_count=select_all_order_row($this->table,'id','DESC')->num_rows();
        // $id_pas=$pas->id+1;
        // $count_pas=$pas_count+1;
        // $buid=get_user_buid($this->input->post('nik'));
        // $code_pas='PAS/'.$buid.'/'.date('m').'/'.date('Y').'/'.$id_pas;
        $data = array(
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $r) {
            ...
            $row[] = ' <a href="'.base_url().'competency/personal_assesment/approve/'.$r->id.'"><button type="button" class="btn btn-primary" title="Klik disini untuk melihat detail"><i class="icon-info"></i></button></a>
                                              <a href="'.base_url().'competency/personal_assesment/edit/'.$r->id.'"><button type="button" class="btn btn-primary" title="Klik disini untuk merubah"><i class="icon-pencil"></i></button></a>
                                              <a class="btn btn-sm btn-light-azure" target="_blank" href="'.base_url().'competency/personal_assesment/print_pdf/'.$r->id.'" title="Klik icon ini untuk mencetak form pengajuan"><i class="icon-print"></i></a>';
            $data[] = $row;
        }
