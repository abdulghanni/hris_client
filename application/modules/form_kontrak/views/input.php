          ...
          <div class="col-md-12">
            <div class="grid simple">
              <div class="grid-title no-border">
                <h4>Input Pengajuan <span class="semi-bold"><a href="<?php echo site_url('form_kontrak')?>">Perpanjangan Kontrak</a></span></h4>
              </div>
              <div class="grid-body no-border">
                  ...
                  <div class="row column-seperation">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="row form-row">
                        ...
                        <div class="col-md-8">
                          <select name="lama_kontrak" class="select2" style="width:100%">
                            <option value="0">-- Pilih Lama Perpanjangan --</option>
                            <?php foreach ($lama->result() as $key) {
                      ...
                      <div class="row form-row">
                        ...
                        <div class="col-md-8">
                          ...
                          <input type="text" class="form-control" name="date_kontrak" required>
                ...
                <div class="form-actions">
                  <div class="pull-right">
                    ...
                    <a href="<?php echo site_url('form_kontrak')?>"><button class="btn btn-white btn-cons" type="button">Cancel</button></a>
                  </div>
                </div>
              </form>
              </div>
