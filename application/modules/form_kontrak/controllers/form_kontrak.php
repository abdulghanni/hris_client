...
class Form_kontrak extends MX_Controller {
    ...
    function send_notif_tambahan($id, $user_id)
    {
        ...
        $subject_email = 'Pengajuan Kontrak Karyawan';
        $isi_email = 'HRD telah menyetujui perpanjangan kontrak untuk '.get_name($user_id).', untuk melihat detail silakan <a class="klikmail" href='.$url.'>Klik Disini</a><br />';
        //Notif to karyawan
        if(!empty($receiver)){
            $data4 = array(
