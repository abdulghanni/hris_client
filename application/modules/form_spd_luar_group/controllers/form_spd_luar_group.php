...
class Form_spd_luar_group extends MX_Controller {
    ...
    { 
        ...
        else
        {
            ...
            $ftitle_post = (strlen($ftitle_re) > 0) ? array('creator.username'=>$ftitle_re) : array() ;
    ...
    function do_approve($id, $type)
    {
        ...
        if(!empty($user_app)):
            ...
            if(!empty(getEmail(1)))$this->send_email(getEmail(1), 'Pengajuan Perjalanan Dinas Luar Kota (Group)', $isi_email_request);
            ...
            if ($this->form_validation->run() == true && $this->form_spd_luar_group_model->create_($task_receiver,$additional_data))
            {
                ...
                if($task_creator!==$created_by):
                 ...
                 if(!empty($user_app_lv1)):
                    ...
                    if(!empty(getEmail(1)))$this->send_email(getEmail(1), 'Pengajuan Perjalanan Dinas Luar Kota (Group)', $isi_email);
