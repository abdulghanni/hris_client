                  ...
                  <div class="col-md-7">
                    ...
                    <div class="row form-row">
                      ...
                      <div class="row form-row">
                        ...
                        <div class="col-md-9">
                          <input name="title" id="title" type="text"  class="form-control" placeholder="Dalam Rangka" value="<?php echo $td->city_to; ?>" disabled>
                        </div>
                      </div>
                      <div class="row form-row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                          <input name="title" id="title" type="text"  class="form-control" placeholder="Dalam Rangka" value="<?php echo $td->city_from; ?>" disabled>
                        </div>
                      </div>
                      <div class="row form-row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                          <input name="title" id="title" type="text"  class="form-control" placeholder="Dalam Rangka" value="<?php echo $td->transportation_nm; ?>" disabled>
                        </div>
                      </div>
                      <div class="row form-row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-8">
                          <input name="title" id="title" type="text"  class="form-control" placeholder="Dalam Rangka" value="<?php echo $td->date_spd_start; ?>" disabled>
                        </div>
                      </div>
                      <div class="row form-row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-8">
                          <input name="title" id="title" type="text"  class="form-control" placeholder="Dalam Rangka" value="<?php echo $td->date_spd_end; ?>" disabled>
                        </div>
                      </div>
                  </div>
                </div>
