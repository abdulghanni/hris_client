            ...
            <div class="col-md-12">
              <table class="table no-more-tables">
                ...
                <tr>
                  ...
                  <td>
                    <input type="hidden" name="inventory_id_update[]" value="<?php echo $inv->id?>">
                    <label class="radio-inline">
                      <input type="radio" name="is_available_update<?php echo $i?>" id="is_available_update<?php echo $inv->id?>-1" value="1" <?php echo ($inv->is_available==1)?'checked':''?>>Ada
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="is_available_update<?php echo $i?>" id="is_available_update<?php echo $inv->id?>-1" value="0" <?php echo ($inv->is_available==0)?'checked':''?>>Tidak
                    </label>
                  </td>
                  <td><input name="note_update<?php echo $i?>" id="note_update<?php echo $inv->id?>" type="text"  class="form-control" placeholder="" value="<?php echo $inv->note?>"></td>
                </tr>
                    <?php endforeach;}?>
              </table>
