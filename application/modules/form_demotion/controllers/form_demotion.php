...
class Form_demotion extends MX_Controller {
    ...
    function detail($id, $lv = null)
    {
        ...
        if (!$this->ion_auth->logged_in())
        {
           ...
           $this->data['id'] = $id;
            ...
            $this->data['user_folder'] = $user_id.trim($first_name).'/demosi/';
    ...
    function upload_attachment($id)
    {
        ...
        if(!is_dir("./uploads/$user_folder/demosi/")){
        mkdir("./uploads/$user_folder/demosi/", 0777);
        }


        $path = "./uploads/$user_folder/demosi/";
