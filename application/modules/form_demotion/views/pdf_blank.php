...
<div class="style4">
  ...
  Perihal : Pengajuan Demosi Karyawan <br/><br/>
  Kepada Yth.,<br/>
  Departemen HRD<br/>
  Di Tempat<br/>

  <p>Dengan hormat,</p>
  <p>Sesuai evaluasi kinerja karyawan terlampir, bersama ini kami sampaikan permohonan proses Demosi karyawan atas nama  dengan data sebagai berikut:</p>
</div>
  ...
  <table width="800" height="128" border-style:solid border="1" class="tg">
    <thead>
      ...
      <tr>
        <td><span class="style3">Tanggal Demosi </span></td>
        <td><div align="center">&nbsp;</div></td>
        <td><span class="style3"></span></td>
      </tr>
      <tr>
        <td height="100"><span class="style3">Alasan Demosi</span></td>
