        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Pengaturan <span class="semi-bold"><?php echo 'Biaya PJD Training/Meeting' ?></span></h4>
            </div>
            ...
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="table table-bordered table-hover table-full-width " id="table" style="width: 100%;">
                    <thead>
                         <tr>
                          <th colspan="9" scope="col" width="100%" class="text-center">Biaya PJD Training/Meeting</th>
                        </tr>
                         <tr>
                    ...
                    <tbody>
                      <tr>
                        <td>Uang Makan Perjalanan</td>
                        <?php for($i=1;$i<=19;$i+=3){
                            $v = number_format(getValue('jumlah_biaya', 'pjd_training_biaya', array('id'=>'where/'.$i)), 0);
                          ?>
            ...
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="table table-bordered table-hover table-full-width " id="table" style="width: 100%;">
                    <thead>
                         <tr>
                          <th colspan="9" scope="col" width="100%" class="text-center">Biaya PJD Training/Meeting Intern</th>
                        </tr>
                         <tr>
                          <th rowspan="2" scope="col" width="20%">Komponen Biaya</th>
                          <th colspan="7" scope="col" width="70%" class="text-center">Biaya PJD/Golongan</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <?php for($i=101;$i<=119;$i+=3){
                            $v = number_format(getValue('jumlah_biaya', 'pjd_training_biaya_intern', array('id'=>'where/'.($i-100))), 0);
                          ?>
...
<script type="text/javascript"> 
 ...
 function changeVal(ID){
        ...
        $.ajax({
          type: "POST",
          url: "<?=base_url()?>biaya_pjd_training/update/"+ID,
          data: dataString,
          cache: false,
