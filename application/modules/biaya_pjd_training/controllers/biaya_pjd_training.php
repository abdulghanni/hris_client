...
class biaya_pjd_training extends MX_Controller {

  public $data;
  var $form_name = 'biaya_pjd_trining';
    ...
    function index()
    {
        ...
        }
        {
            ...
            $this->_render_page('biaya_pjd_training/index', $this->data);
        }
    }
    ...
    function _render_page($view, $data=null, $render=false)
    {
        ...
        if ( ! $render)
        {
            $this->load->library('template');
                ...
                if(in_array($view, array('biaya_pjd_training/index')))
                {
