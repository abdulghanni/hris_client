                        ...
                        <table class="table table-striped table-flip-scroll cf">
                            ...
                            <tbody>
                              ...
                              $txt_app_lv1 = $txt_app_lv2 = $txt_app_lv3 = $txt_app_hrd = "<i class='icon-question' title = 'no respond'></i>";
                                ...
                                $btn_rep = ($report_num>0)?'<i class="icon-paste"></i> View Report':(($report_num < 1 && get_nik($sess_id) == $spd->task_receiver)?'<i class="icon-paste"></i> Create Report':'<i class="icon-paste"></i>  Report');
                                }
                               ?>
                                <tr>
                                  <td>
                                  ...
                                  <td>
                                    <div class="list-actions">
                                      ...
                                      <button class="btn btn-info btn-cons" <?php echo $reject2 ?> type="button" onclick='window.location.href="<?php echo base_url()?>form_spd_luar/report/<?php echo $spd->id ?>"' <?php echo $report_disable?>>
                                          <?php echo $btn_rep; ?>
                                        </button>
                                      </a>
