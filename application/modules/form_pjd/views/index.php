            ...
            <div class="grid simple ">
                <div class="grid-body">
                      ...
                      <div class="table-responsive">       
                        <table class="table table-striped table-flip-scroll cf" id="table">
                            <thead>
                              <tr>
                                <th rowspan="2" scope="col"  width="5%">No.</th>
                                <th rowspan="2" scope="col"  width="70%">Kegiatan</th>
                                <th rowspan="2" scope="col"  width="70%">Tanggal Pengajuan</th>
                                <th colspan="4" scope="col" class="text-center" width="15%">Approval Atasan</th>
                                <th rowspan="2" scope="col" class="text-center">Action</th>
                              </tr>
                               <tr>
                                  <th scope="col" class="text-center" width="3%">Langsung</th>
                                  <th scope="col" class="text-center" width="3%">Tidak Langsung</th>
                                  <th scope="col" class="text-center" width="3%">Lainnya</th>
                                  <th scope="col" class="text-center" width="3%">HRD</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
