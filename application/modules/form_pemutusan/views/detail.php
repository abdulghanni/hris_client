          ...
          <div class="col-md-12">
            <div class="grid simple">
              <div class="grid-title no-border">
                <h4>Form Pengajuan <span class="semi-bold"><a href="<?php echo site_url('form_pemutusan')?>">Pemutusan Kontrak</a></span></h4>
              <a href="<?php echo site_url('form_pemutusan/form_pemutusan_pdf/'.$id)?>" target="_blank"><button class="btn btn-primary pull-right"><i class="icon-print"> Cetak</i></button></a><br/>
              No : <?= get_form_no($id) ?>
              </div>
              <div class="grid-body no-border">
                <?php
                $att = array('class' => 'form-no-horizontal-spacing', 'id' => '');
                echo form_open('form_pemutusan/add', $att);
                if($_num_rows>0){
                  ...
                  <div class="row column-seperation">
                   ...
                   <div class="col-md-6">
                      ...
                      <div class="row form-row">
                        ...
                        <div class="col-md-8">
                          <textarea name="alasan" id="alasan" class="form-control" placeholder="" readonly="readonly"><?php echo $row->alasan ?></textarea>
                        </div>
                      </div>
                ...
                <div class="form-actions">
                  ...
                  <div class="row form-row">
                    ...
                    <?php }endfor;
                      if($row->is_app_hrd == 1 && get_nik($sess_id) == $this->approval->approver('kontrak', $user_nik)){?>
                  ...
                  <div class="col-md-3" id="hrd">
                    ...
                    <div class="col-md-12"><span class="semi-bold">Diterima HRD</span><br/><br/></div>
                      ...
                      <?php }else{?>
                        ...
                        <span class="small"></span><br/>
                        <span class="semi-bold"></span><br/>
                        <span class="semi-bold"><?php echo get_name($this->approval->approver('kontrak', $user_nik))?></span><br/>
                        <span class="small"><?php echo dateIndo($row->date_app_hrd)?></span><br/>
                        <span class="semi-bold">(HRD)</span>
                      <?php } ?>
                    </p>
