          ...
          <div class="col-md-12">
            <div class="grid simple">
              <div class="grid-title no-border">
                <h4>Input Pengajuan <span class="semi-bold"><a href="<?php echo site_url('form_pemutusan')?>">Pemutusan Kontrak</a></span></h4>
              </div>
              <div class="grid-body no-border">
                <?php
                $att = array('class' => 'form-no-horizontal-spacing', 'id' => 'formadd');
                echo form_open_multipart('form_pemutusan/add', $att);
                ?>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="row form-row">
                        ...
                        <div class="col-md-8">
                          ...
                          <input type="text" class="form-control" name="date_pemutusan" required>
                ...
                <div class="form-actions">
                  <div class="pull-right">
                    ...
                    <a href="<?php echo site_url('form_pemutusan')?>"><button class="btn btn-white btn-cons" type="button">Cancel</button></a>
                  </div>
                </div>
              </form>
              </div>
