                          ...
                          <table class="table table-striped table-flip-scroll cf">
                              ...
                              <?php if($_num_rows>0){
                                ...
                                //Approval Level 1
                                  ...
                                  //Approval HRD
                                    if($this->approval->approver('medical', get_nik($row->user_id)) == $sess_nik && $row->is_app_hrd == 0){
                                  ...
                                  <tr>
                                    <td><?php $sess_id = $this->session->userdata('user_id'); echo (($row->is_app_lv1 == 0 && $row->created_by == $sess_id) || is_admin()) ? '<button onclick="showModal('.$row->id.')" class="btn btn-danger btn-mini" type="button" title="Batalkan Pengajuan"><i class="icon-remove"></i></button>' : ''?>
                                     </td>
